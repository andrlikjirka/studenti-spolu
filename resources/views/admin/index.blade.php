                ...
                <div class="col-lg-10">
                    <div class="row row-cols-1 row-cols-md-2 g-3 ">
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-body p-4 text-center">
                                    <h5 class="card-title"><a href="{{ route('admin.projekty.index') }}" class="text-decoration-none ">Administrace projektů<br>a správa nabídek spolupráce</a></h5>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-card-text text-primary" viewBox="0 0 16 16">
                        ...
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-body p-4 text-center">
                                    <h5 class="card-title"><a href="{{ route('admin.uzivatele.index') }}" class="text-decoration-none">Administrace uživatelů<br><br></a></h5>
                        ...
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-body p-4 text-center">
                                    <h5 class="card-title"><a href="{{ route('admin.zadosti.index') }}" class="text-decoration-none">Administrace žádostí o spolupráci<br><br></a></h5>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-chat-left text-primary" viewBox="0 0 16 16">
