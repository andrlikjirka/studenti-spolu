                ...
                <div class="col-lg-10">
                    <div class="row row-cols-1 row-cols-md-2 g-3">
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-body p-4 text-center">
                                    <h5 class="card-title"><a href="" class="text-decoration-none">Administrace projektů</a></h5>
                        ...
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-body p-4 text-center">
                                    <h5 class="card-title"><a href="" class="text-decoration-none">Administace uživatelů</a></h5>
                        ...
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-body p-4 text-center">
                                    <h5 class="card-title"><a href="" class="text-decoration-none">Administráce žádostí o spolupráci</a></h5>
